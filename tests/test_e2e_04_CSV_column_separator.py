...
def test_both_csv_tab_separated(lhs, rhs, capfd):
...
def test_left_tab_right_comma_separated(lhs, rhs, capfd):
...
def test_left_comma_right_tab_separated(lhs, rhs, capfd):
...
def test_left_comma_right_semicolon_separated(lhs, rhs, capfd):
...
def test_left_semicolon_right_tab_separated(lhs, rhs, capfd):
